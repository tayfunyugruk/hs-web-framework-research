...
const pageNavigation = document.querySelectorAll('.multicolumn-card__info a.link.animate-arrow');
pageNavigation.forEach((anchor) => {
  if (anchor.href === window.location.href) {
    anchor.style.color = 'white'
    anchor.parentNode.parentNode.style.backgroundColor = '#2c00e3';
  }
})